...
This script standardizes the csv's created in collect_raw_data.py to ensure consistency across datasets and prevents merge/key errors caused by inconsistent naming. Please note this script assumes `assumed collect_raw_data.py` has been run to create the inital batch of data files. 
